  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v2.html",
        filename: "antivirus_end001_v2.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v3.html",
        filename: "antivirus_end001_v3.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v4.html",
        filename: "antivirus_end001_v4.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v5.html",
        filename: "antivirus_end001_v5.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v6.html",
        filename: "antivirus_end001_v6.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v7.html",
        filename: "antivirus_end001_v7.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v8.html",
        filename: "antivirus_end001_v8.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/antivirus_end001_v9.html",
        filename: "antivirus_end001_v9.html",
      }),
