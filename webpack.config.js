  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v1.html",
        filename: "end006_v1.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v2.html",
        filename: "end006_v2.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v3.html",
        filename: "end006_v3.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v4.html",
        filename: "end006_v4.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v5.html",
        filename: "end006_v5.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
        minify: true,
        template: "src/end006_v6.html",
        filename: "end006_v6.html",
      }),
      new HtmlWebpackPlugin({
        inject: mode == "production" ? false : true,
        scriptLoading: "defer",
